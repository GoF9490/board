...
exports.view = (login, id, data)=>{
    ...
    <article id="view_wrap" class="board_mg">
            <form class="write_wrap" name="view" action="/delete_process" method="post">
...
exports.write = (login)=>{
    ...
    <article id="write_wrap" class="board_mg">
        <form name="write_wrap" class="write_wrap" action="/write_process" method="post">
            <div class="write_balance">
                <input type="text" name="title" class="input_title" placeholder="제목을 입력하세요.">
            </div>
            <div class="write_balance">
                작성자 : ${login.nickname}
            </div>
            <div class="write_balance">
                <textarea name="content" class="input_content" placeholder="내용을 입력하세요."></textarea>
            </div>
